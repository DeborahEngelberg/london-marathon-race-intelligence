...
const INITIAL_SECTIONS: CheckSection[] = [
  {
    ...
    items: [
      { id: 'w1', label: 'Collect race pack at ExCeL London Expo', detail: 'ExCeL London, Custom House station (DLR/Elizabeth line). Wed 22 - Sat 25 April. Go Wed or Thu to avoid queues. Bring photo ID. If you can\'t attend, a nominated person can collect for you with a copy of your photo ID, a signed letter from you authorising them by name, and their own ID.', done: false },
      ...
      { id: 'w3', label: 'Check bib has timing chip attached', detail: 'The timing chip is embedded in your bib number. Pin your bib to the front of your top using all four safety pins from your race pack. No separate shoe chip needed.', done: false },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'r4', label: 'Double-check: bib pinned (4 pins), gels packed', detail: 'Your timing chip is in the bib. Quick visual check before leaving. Forgetting your bib ruins your race.', done: false },
